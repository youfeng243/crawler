...
class CleanExitEvent:
    def __init__(self):
        ...
        self.db_company = MongDb(mongo_conf['host'], mongo_conf['port'], mongo_conf['final_db'],
                                 mongo_conf['username'],
                                 mongo_conf['password'])
        self.sourceTable = 'exit_event'
        self.targetTable = 'exit_event'
    ...
    def do_clean(self,item):
        ...
        item["divestment_date"] = self.deal_date(divestment_date)
        item["first_investment_date"] = self.deal_date(first_investment_date)
